...
# Z-Image is the recommended default for best results
PROMPT_STYLES = ["Z-Image", "Structured", "Full", "Natural", "Tags", "Hybrid"]

# Style map
STYLE_MAP = {
    "Z-Image": PromptStyle.ZIMAGE,
    "Structured": PromptStyle.STRUCTURED,
    "Full": PromptStyle.FULL,
        ...
        return {
            "required": {
                ...
                "prompt_style": (PROMPT_STYLES, {
                    "default": "Structured",
                    "tooltip": "Natural: Prose | Tags: Comma-separated | Hybrid: Sentence + tags | Structured: Category-labeled | Full: Florence description + all tags (max info)"
                }),
