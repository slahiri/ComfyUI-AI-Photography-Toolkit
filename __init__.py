...
async def comfy_entrypoint() -> SIDPhotographyToolkitExtension:
    ...
    if _server_available:
        try:
            ...
            # Register prompt editor routes (includes debug-results and generation-results viewers)
            from .prompt_editor import setup_routes as setup_editor_routes
            setup_editor_routes(PromptServer.instance.routes)
